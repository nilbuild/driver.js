...
description: "Style the Driver.js popover with custom classes or the onPopoverRender callback. Override the default styles or fully customize the popover DOM per step."
groupTitle: "Examples"
sort: 2
---
