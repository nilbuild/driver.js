...
description: "Highlight any element on the page with Driver.js. Spotlight a single element and show a popover to deliver contextual help, beyond just product tours."
groupTitle: "Examples"
sort: 11
---
